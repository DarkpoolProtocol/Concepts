...
#git remote add origin git@github.com:DarkpoolProtocol/Concepts.git  


#git remote add concept git@jjheskgithub:github.com/DarkpoolProtocol/Concepts.git
git add .
git commit -m "modified changes with edition v$VERSION"
#git remote set-url --push dapprotocol https://gitee.com/darkpoolprotocal/whitepaper.git
#git remote add origin https://gitee.com/darkpoolprotocal/whitepaper.git
